import { a as Buffer$1, c as cryptoBrowserify, $ as $hgUW1$bnjs, b as $hgUW1$elliptic, g as getDefaultExportFromCjs, p as process$1, d as commonjsGlobal, e as eventsExports } from "./index-4OmLNdFl.js";
...
function compliment(number) {
  ...
  var s2 = "", l = number.length, dec = number.split(".")[1], ld = dec ? dec.length : 0;
  for (var i = 0; i < l; i++) {
    if (number[i] >= "0" && number[i] <= "9")
      s2 += 9 - parseInt(number[i]);
    else
      s2 += number[i];
  }
  var one = ld > 0 ? "0." + new Array(ld).join("0") + "1" : "1";
  return addCore(s2, one);
}
...
class $62ca61b6ba036e1b$export$2e2bcd8739ae039 {
  static sha1(buf) {
    ...
    return cryptoBrowserify.createHash("sha1").update(buf).digest();
  }
  static sha256(buf) {
    $e44f707fde477092$export$2e2bcd8739ae039.validateArgument($9f918c10ad4fef51$export$2e2bcd8739ae039.isBuffer(buf), "buf", "Must be Buffer");
    return cryptoBrowserify.createHash("sha256").update(buf).digest();
  }
  static sha512(buf) {
    $e44f707fde477092$export$2e2bcd8739ae039.validateArgument($9f918c10ad4fef51$export$2e2bcd8739ae039.isBuffer(buf), "buf", "Must be Buffer");
    return cryptoBrowserify.createHash("sha512").update(buf).digest();
  }
  static ripemd160(buf) {
    $e44f707fde477092$export$2e2bcd8739ae039.validateArgument($9f918c10ad4fef51$export$2e2bcd8739ae039.isBuffer(buf), "buf", "Must be Buffer");
    return cryptoBrowserify.createHash("ripemd160").update(buf).digest();
  }
...
class $369a157b63fbc3fd$export$2e2bcd8739ae039 {
  ...
  */
  ...
  static parseSchnorrEncodedSig(buf) {
    ...
    let s2 = buf.subarray(32, 64);
    return {
      r: $5aa97aebe18a7924$export$2e2bcd8739ae039.fromBuffer(r),
      s: $5aa97aebe18a7924$export$2e2bcd8739ae039.fromBuffer(s2)
    };
  }
  /**
  ...
  */
  static parseDER(buf, strict) {
    ...
    let s2 = $5aa97aebe18a7924$export$2e2bcd8739ae039.fromBuffer(sbuf);
...
class $2a1cae3adbd93346$export$2e2bcd8739ae039 {
  ...
  sign() {
    ...
    let d2 = privkey.bn;
    $e44f707fde477092$export$2e2bcd8739ae039.validateState(!isNil(hashbuf) && !isNil(privkey) && !isNil(d2), "invalid parameters");
    ...
    let obj = this._findSignature(d2, e);
...
class $ba7e1a38972b2d09$export$2e2bcd8739ae039 {
  ...
  * @throws A validation error if exists
  */
  static ecPoint(x, y2, isRed) {
    return new $ba7e1a38972b2d09$export$2e2bcd8739ae039(this.ec.point(x, y2, isRed));
  }
  /**
  *
...
class $246eb589bb078d6d$export$2e2bcd8739ae039 {
  ...
  */
  toBuffer() {
    ...
    let y2 = this.point.getY();
    let xbuf = x.toBuffer({
      size: 32
    });
    let ybuf = y2.toBuffer({
      size: 32
    });
    let prefix;
    if (!this.compressed) {
  ...
  */
  static _transformDER(buf, strict) {
    ...
    if (buf[0] === 4 || !strict && (buf[0] === 6 || buf[0] === 7)) {
      ...
      let y2 = new $5aa97aebe18a7924$export$2e2bcd8739ae039(ybuf);
      return {
        point: $ba7e1a38972b2d09$export$2e2bcd8739ae039.ecPoint(x, y2),
        compressed: false
      };
    } else if (buf[0] === 3) {
  ...
  */
  static _transformObject(json) {
    ...
    let y2 = new $5aa97aebe18a7924$export$2e2bcd8739ae039(json.y, "hex");
    let point = $ba7e1a38972b2d09$export$2e2bcd8739ae039.ecPoint(x, y2);
    return {
      point,
...
class $1ef65db4b26d2b16$export$2e2bcd8739ae039 extends $2a1cae3adbd93346$export$2e2bcd8739ae039 {
  ...
  sigError() {
    ...
    let r = this.sig.r;
    let s2 = this.sig.s;
    if (!(r.gt($5aa97aebe18a7924$export$2e2bcd8739ae039.Zero) && r.lt($ba7e1a38972b2d09$export$2e2bcd8739ae039.getN())) || !(s2.gt($5aa97aebe18a7924$export$2e2bcd8739ae039.Zero) && s2.lt($ba7e1a38972b2d09$export$2e2bcd8739ae039.getN()))) return "r and s not in range";
  ...
  _findSignature(d2, e) {
    ...
    do {
      ...
      s2 = k.invm(N).mul(e.add(d2.mul(r))).umod(N);
    } while (r.cmp($5aa97aebe18a7924$export$2e2bcd8739ae039.Zero) <= 0 || s2.cmp($5aa97aebe18a7924$export$2e2bcd8739ae039.Zero) <= 0);
    s2 = $1ef65db4b26d2b16$export$2e2bcd8739ae039.toLowS(new $5aa97aebe18a7924$export$2e2bcd8739ae039(s2));
    return {
      s: s2,
  ...
  static toLowS(s2) {
    if (s2.gt($5aa97aebe18a7924$export$2e2bcd8739ae039.fromBuffer(Buffer$1.from("7FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF5D576E7357A4501DDFE92F46681B20A0", "hex")))) s2 = $ba7e1a38972b2d09$export$2e2bcd8739ae039.getN().sub(s2);
    return s2;
  }
  calcI() {
    for (let i = 0; i < 4; i++) {
  ...
  toPublicKey() {
    ...
    let rInv = r.invm(n);
    let Q = R.mul(s2).add(G.mul(new $5aa97aebe18a7924$export$2e2bcd8739ae039(eNeg))).mul(new $5aa97aebe18a7924$export$2e2bcd8739ae039(rInv));
...
class $1739481af0c86d04$export$2e2bcd8739ae039 extends $2a1cae3adbd93346$export$2e2bcd8739ae039 {
  ...
  */
  _findSignature(d2, e) {
    let n = $ba7e1a38972b2d09$export$2e2bcd8739ae039.getN();
    let G = $ba7e1a38972b2d09$export$2e2bcd8739ae039.getG();
    $e44f707fde477092$export$2e2bcd8739ae039.validateState(!d2.lte(new $5aa97aebe18a7924$export$2e2bcd8739ae039(0)), "privkey out of field of curve");
    $e44f707fde477092$export$2e2bcd8739ae039.validateState(!d2.gte(n), "privkey out of field of curve");
    let k = this.nonceFunctionRFC6979(d2.toBuffer({
      size: 32
    }), e.toBuffer({
      size: 32
    }));
...
class $7daa49d6586b1e1a$export$2e2bcd8739ae039 {
  ...
  static decode(s2) {
    if (typeof s2 !== "string") throw new Error("Input must be a string");
    let buf = Buffer$1.from($5d1fb851ba849ee0$export$2e2bcd8739ae039.decode(s2));
...
class $90f45db77a786f2b$export$2e2bcd8739ae039 {
  ...
  */
  replaceChunk(index2, replacement) {
    if (index2 < 0 || index2 >= this.chunks.length) return false;
    this.chunks.splice(index2, 1, ...replacement.chunks);
    return true;
  }
  /**
  ...
  */
  static getDerivationIndexes(path) {
    ...
    let indexes = steps.slice(1).map((step) => {
      ...
      let index2 = +step;
      if (isHardened) index2 += this.Hardened;
      return index2;
    });
...
class $ef69ee312dbfbba6$export$2e2bcd8739ae039 {
  ...
  */
  ...
  _deriveWithNumber(index2, hardened) {
    if (index2 >= $850698057fd6f95c$export$2e2bcd8739ae039.Hardened || hardened) throw new $824be92afb10ca74$export$1efb2ac49bec6b75();
    if (index2 < 0) throw new $824be92afb10ca74$export$b59b0d37c3755b05(index2);
    let indexBuffer = $9f918c10ad4fef51$export$2e2bcd8739ae039.integerAsBuffer(index2);
    ...
    let buffers = {
      ...
      childIndex: $9f918c10ad4fef51$export$2e2bcd8739ae039.integerAsBuffer(index2),
...
class $8fc74ca0a6995b3b$export$2e2bcd8739ae039 {
  ...
  */
  ...
  _deriveWithNumber(index2, hardened) {
    if (!$8fc74ca0a6995b3b$export$2e2bcd8739ae039.isValidPath(index2, hardened)) throw new $824be92afb10ca74$export$b59b0d37c3755b05(index2);
    hardened = index2 >= $850698057fd6f95c$export$2e2bcd8739ae039.Hardened ? true : hardened;
    if (index2 < $850698057fd6f95c$export$2e2bcd8739ae039.Hardened && hardened === true) index2 += $850698057fd6f95c$export$2e2bcd8739ae039.Hardened;
    let indexBuffer = $9f918c10ad4fef51$export$2e2bcd8739ae039.integerAsBuffer(index2);
    let data;
    if (hardened) {
...
class $fea109eb8128bf4c$export$2e2bcd8739ae039 {
  ...
  */
  static buildScriptTemplateOut(to, groupId, groupAmount) {
    ...
    let s2 = $90f45db77a786f2b$export$2e2bcd8739ae039.fromBuffer(bfr);
    if (!isNil(groupId) && !isNil(groupAmount)) {
      ...
      s2.chunks = s2.chunks.slice(1);
      s2.prepend(groupAmount).prepend(groupId);
    }
    return s2;
  }
  /**
  ...
  */
  static buildDataOut(data, encoding) {
    ...
    let s2 = $90f45db77a786f2b$export$2e2bcd8739ae039.empty().add($92c0719d4ab9ac45$export$393941f88fd16991.OP_RETURN);
    if (!isUndefined(data)) s2.add(data);
    return s2;
  }
  /**
  ...
  */
  static buildTokenDescriptionLegacy(ticker, name, docUrl, docHash, decimals) {
    ...
    let s2 = $90f45db77a786f2b$export$2e2bcd8739ae039.empty().add($92c0719d4ab9ac45$export$393941f88fd16991.OP_RETURN).add($5aa97aebe18a7924$export$2e2bcd8739ae039.fromNumber($a0743653d736276e$export$8da1cb8322810fc2.LEGACY).toScriptNumBuffer()).add(Buffer$1.from(ticker)).add(Buffer$1.from(name));
    if (docUrl && docUrl.length > 0) {
      ...
      s2.add(Buffer$1.from(docUrl)).add(Buffer$1.from(docHash, "hex").reverse());
    } else s2.add($92c0719d4ab9ac45$export$393941f88fd16991.OP_FALSE).add($92c0719d4ab9ac45$export$393941f88fd16991.OP_FALSE);
    if (isNumber$1(decimals)) {
      ...
      s2.add(decimals <= 16 ? $92c0719d4ab9ac45$export$2e2bcd8739ae039.smallInt(decimals) : $5aa97aebe18a7924$export$2e2bcd8739ae039.fromNumber(decimals).toScriptNumBuffer());
    }
    return s2;
  }
  /**
...
class $6995bc57838749e2$export$2e2bcd8739ae039 extends $9b92277fa5d35484$export$2e2bcd8739ae039 {
  ...
  */
  ...
  _estimateScriptSize() {
    let s2 = $90f45db77a786f2b$export$2e2bcd8739ae039.empty().add(this.templateScript.toBuffer());
    if (this.constraintScript instanceof $90f45db77a786f2b$export$2e2bcd8739ae039) s2.add(this.constraintScript.toBuffer());
    return s2.toBuffer().length + 1 + 64;
  }
}
class $926e193f4c554367$export$2e2bcd8739ae039 {
  ...
  */
  ...
  _removeOutput(index2) {
    this.outputs = this.outputs.filter((_, i) => i !== index2);
  }
  /**
  ...
  */
  ...
  updateOutputAmount(index2, sats) {
    this.outputs[index2].value = BigInt(sats);
    this._updateChangeOutput();
  }
  /**
...
Object.defineProperty(_wordlists$1, "__esModule", { value: true });
const wordlists$1 = {};
var wordlists_1 = _wordlists$1.wordlists = wordlists$1;
let _default;
var _default_1 = _wordlists$1._default = _default;
try {
  _default_1 = _wordlists$1._default = _default = require$$0;
  wordlists$1.czech = _default;
} catch (err) {
}
try {
  _default_1 = _wordlists$1._default = _default = require$$1;
  wordlists$1.chinese_simplified = _default;
} catch (err) {
}
try {
  _default_1 = _wordlists$1._default = _default = require$$2;
  wordlists$1.chinese_traditional = _default;
} catch (err) {
}
try {
  _default_1 = _wordlists$1._default = _default = require$$3;
  wordlists$1.korean = _default;
} catch (err) {
}
try {
  _default_1 = _wordlists$1._default = _default = require$$4;
  wordlists$1.french = _default;
} catch (err) {
}
try {
  _default_1 = _wordlists$1._default = _default = require$$5;
  wordlists$1.italian = _default;
} catch (err) {
}
try {
  _default_1 = _wordlists$1._default = _default = require$$6;
  wordlists$1.spanish = _default;
} catch (err) {
}
try {
  _default_1 = _wordlists$1._default = _default = require$$7;
  wordlists$1.japanese = _default;
  wordlists$1.JA = _default;
} catch (err) {
}
try {
  _default_1 = _wordlists$1._default = _default = require$$8;
  wordlists$1.portuguese = _default;
} catch (err) {
}
try {
  _default_1 = _wordlists$1._default = _default = require$$9;
  wordlists$1.english = _default;
  wordlists$1.EN = _default;
} catch (err) {
}
const _wordlists = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  get _default() {
    return _default_1;
  },
  default: _wordlists$1,
  wordlists: wordlists_1
}, [_wordlists$1]);
...
const index = /* @__PURE__ */ getDefaultExportFromCjs(ms);
const ms$1 = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  default: index
}, [ms]);
function setup(env) {
...
var common = setup;
const common_default = /* @__PURE__ */ getDefaultExportFromCjs(common);
...
(function(module2, exports$1) {
  ...
  module2.exports = common$1(exports$1);
...
var browser = ws;
const WebSocket$1 = /* @__PURE__ */ getDefaultExportFromCjs(browser);
...
function isSafeNumber(value, config) {
  ...
  var s2 = extractSignificantDigits(str);
  if (v === s2) {
    return true;
  }
  if ((config === null || config === void 0 ? void 0 : config.approx) === true) {
    var requiredDigits = 14;
    if (!isInteger(value) && s2.length >= requiredDigits && v.startsWith(s2.substring(0, requiredDigits))) {
      return true;
    }
  }
  return false;
...
class ElectrumClient extends eventsExports.EventEmitter {
  ...
  async disconnect(force = false, retainSubscriptions = false) {
    ...
    for (const index2 in this.requestResolvers) {
      const requestResolver = this.requestResolvers[index2];
      requestResolver(new Error("Manual disconnection"));
      delete this.requestResolvers[index2];
    }
...
function $6f559318d8845d29$export$d6e8eb22902c6b88(accountKey, fromRIndex, rIndex, fromCIndex, cIndex) {
  ...
  let rKeys = [], cKeys = [];
  for (let index2 = fromRIndex; index2 < rIndex; index2++) {
    let k = receive.deriveChild(index2, false);
  ...
  for (let index2 = fromCIndex; index2 < cIndex; index2++) {
    let k = change.deriveChild(index2, false);
    let addr = k.privateKey.toAddress().toString();
    cKeys.push({
      key: k,
      address: addr,
...
async function $6f559318d8845d29$var$discoverUsedAccountIndexes(deriveKey) {
  let lastUsed = -1, index2 = 0, toScan = 20;
  while (toScan > 0) {
    toScan--;
    let rAddr = deriveKey.deriveChild(index2, false).privateKey.toAddress().toString();
...
async function $6f559318d8845d29$export$f421913908d4303e(masterKey) {
  ...
  let index2 = 0;
  while (true) {
    const nexaAccountKey = $6f559318d8845d29$export$b3a12d67e2f5f8c9(masterKey, index2);
    ...
    const nexaAccount = new $5c605efdbcfd6698$export$2e2bcd8739ae039(index2, indexes, $6f559318d8845d29$export$d6e8eb22902c6b88(nexaAccountKey, indexes.rIndex + 1, indexes.rIndex + 20, indexes.cIndex + 1, indexes.cIndex + 20));
    await nexaAccount.loadBalances();
    accounts.push(nexaAccount);
    if (index2 == 0) index2 = 100;
    else index2++;
  }
...
async function $6f559318d8845d29$export$eb24265dd203eccb(masterKey) {
  ...
  for (let index2 = 0; index2 <= lastUsedVaultIndex; index2++) {
    const vaultAccount = new $ce8955c0465759ad$export$2e2bcd8739ae039(1, index2, $6f559318d8845d29$export$1e0ce394ebe84ca9(vaultAccountKey, index2));
...
async function $6f559318d8845d29$export$e3d879d0e09f52c3(masterKey) {
  ...
  for (let index2 = 0; index2 <= lastUsedDappIndex; index2++) {
    const dappAccount = new $448355556707518b$export$2e2bcd8739ae039(2, index2, $6f559318d8845d29$export$1e0ce394ebe84ca9(dappAccountKey, index2));
...
async function $6f559318d8845d29$export$a2ed4b531376a5a4(addresses, fromHeight) {
  let index2 = 0, i = 0, data = /* @__PURE__ */ new Map(), maxHeight = fromHeight;
...
async function $6f559318d8845d29$export$ef13479e8d3251d7(accountType, masterKey) {
  if (accountType == 0) {
    ...
    if (defaultIndexes.rIndex < 0 && defaultIndexes.cIndex < 0) return 0;
      ...
      for (let index2 = 100; ; index2++) {
        const nexaAccountKey = $6f559318d8845d29$export$b3a12d67e2f5f8c9(masterKey, index2);
        const indexes = await $6f559318d8845d29$export$4aeb2c92e53ab137(nexaAccountKey);
        if (indexes.rIndex < 0 && indexes.cIndex < 0) return index2;
      }
...
class $329d65a0aed426f1$export$bba690fb5c12ba04 {
   ...
   */
  async handleParsedInput(input, utxo, index2) {
  }
  /**
...
class $7e26340ce0f64954$export$2e2bcd8739ae039 {
   ...
   */
  getAccountStoreKey(accountType, index2) {
    switch (accountType) {
      case $6f559318d8845d29$export$b8ca5fa4899cbfc7.DAPP_ACCOUNT:
        return String(accountType + "." + index2);
  ...
  importAccount(accountData) {
    let index2 = accountData.getAccountStoreKey();
    if (this._accounts.get(index2)) throw Error("Account already exists!");
    this._accounts.set(String(index2), accountData);
  }
  /**
   ...
   */
  getAccount(index2) {
    return this._accounts.get(index2);
  }
  /**
...
class $8265cc68049fe82c$export$2e2bcd8739ae039 {
  ...
  constructor(data, network) {
    ...
    if (isNil(data)) {
      this.phrase = generateMnemonic_1(128, void 0, wordlists.english);
      const seed = mnemonicToSeedSync_1(this.phrase, "");
      ...
      $006d7f03de390713$export$2e2bcd8739ae039.validateArgument(validateMnemonic_1(data), "Invalid BIP39 seed phrase provided");
      this.phrase = data;
      const seed = mnemonicToSeedSync_1(this.phrase, "");
      const masterKey = $8fc74ca0a6995b3b$export$2e2bcd8739ae039.fromSeed(seed, this._network ?? $149c1bd638913645$export$2e8191f482a38ccd.mainnet);
      this.masterKey = masterKey.deriveChild(44, true).deriveChild(29223, true);
  ...
  static fromSeedPhrase(phrase, network) {
    ...
    $006d7f03de390713$export$2e2bcd8739ae039.validateArgument(validateMnemonic_1(phrase), "Invalid BIP39 seed phrase provided");
...
//# sourceMappingURL=index.web-DbMxL4du.js.map
